...
const char HTTP_SAVED[] PROGMEM           = "<div>Credentials Saved<br />Trying to connect the Salt sentry to network.<br />If it fails reconnect to the \"SaltSentry\" access point to try again</div>";
